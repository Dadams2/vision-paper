...
% ─────────────────────────────────────────────────────────────────────────────
%RBG this is a great section! Please keep it for your thesis, or for an extension of this work (example a journal paper) but can't all fit here in 6 pages. will shrink
...
satisfying $X$ (resp. $Y$) alone.  The \emph{J-measure}~\cite{goodman1991rule}
