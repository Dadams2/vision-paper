...
Figure~\ref{fig:overlap-analysis} shows the overlap between consecutive query results varies dramatically across workload types. Realistic visualization-driven workloads (SIMBA drilldown) exhibit high overlap due to progressive narrowing, while our controlled adversarial benchmark produces lower, more varied overlap that tests whether recommenders can identify signal tuples among noise.
