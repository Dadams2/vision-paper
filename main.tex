...
But more importantly no one can agree on what an Insight is. Is it a correlation? A trend? A cluster? A outlier? A distribution? A summary statistic? A visualization? A hypothesis? A question? A story?

\section{Active Learning is not enough}

The most sucessful interactive reccomendation systems such as AIDE \cite{}

\section{One interestingness measure is not enough}
